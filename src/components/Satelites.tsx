    ...
    <section className="satelites-section">
      <div className="satellite">
        <div className="satellite-description">
          ...
          nisl efficitur, sed molestie ligula sodales. Duis vestibulum
          sollicitudin fermentum. Donec ac lectus nec nisi cursus vestibulum
          quis ac mauris. Proin eget magna ac ipsum blandit tincidunt in sit
